...
const dealershipServices = [
  ...
  { icon: Sparkles, number: "04", title: "الكونسيرج", copy: "ننسق معاينتك والطريقة المناسبة للتواصل فور اعتماد بيانات المعرض." },
];
  ...
  return (
    <main dir="rtl" className={`site-shell expanded ${activeCar.color}`}>
      ...
      <header className="site-header">
        <a className="brand" href="#top" onClick={(event) => { event.preventDefault(); scrollToSection("top"); }} aria-label="درايف فورم">
          <img src="/manus-storage/driveform-route-mark_a9149408.png" alt="رمز بصري مجرد لدرايف فورم" />
          <span><b>درايف فورم</b><small>DRIVEFORM</small></span>
        </a>
      ...
      <section className="ticker" aria-label="تعريف بالنموذج"><div>اختيار واضح <i>•</i> صور موثقة <i>•</i> معاينة أقرب لقرارك <i>•</i> DRIVEFORM <i>•</i> اختيار واضح <i>•</i> صور موثقة <i>•</i> معاينة أقرب لقرارك <i>•</i></div></section>

      <section className="fleet-section" id="fleet">
        <div className="paper-meta" aria-hidden="true"><span>INSPECTION PAPER / 01</span><div className="signature-route"><i /><i /><i /></div><span>DRIVEFORM / FILED</span></div>
      ...
      <footer><div className="footer-brand"><img src="/manus-storage/driveform-route-mark_a9149408.png" alt="" /><span><b>درايف فورم</b><small>DRIVEFORM</small></span></div><p>نموذج عرض قابل لتخصيص هوية المعرض والفروع ووسائل التواصل بعد الاعتماد.</p><button onClick={() => scrollToSection("top")}>العودة للأعلى <ChevronDown size={16} /></button></footer>

      <CommandDialog open={searchOpen} onOpenChange={setSearchOpen} title="ابحث في نموذج العرض" description="ابحث في الطرازات والمواصفات ثم انتقل مباشرة إلى الملف المناسب." className="search-command-dialog" showCloseButton={false}>
